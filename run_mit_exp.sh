...
CUDA_VISIBLE_DEVICES=${DEVICES} python3 incremental_train.py --config yolact_mitb2_pascal_config_incremental --resume interrupt --batch_size 32 --load_expert_net weights/20/mix_transformer_769_10000.pth --load_distillation_net weights/1-19/mix_transformer_114_30000.pth
