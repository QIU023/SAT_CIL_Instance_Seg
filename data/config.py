...
yolact_mitb2_coco_config_40with40_incremental = yolact_base_config.copy({
    'name': 'mix_transformer',  # Will default to yolact_resnet50_pascal
...
yolact_resnet50_pascal_config_expert_15with5 = yolact_resnet50_config.copy({
    'name': None,  # Will default to yolact_resnet50_pascal
...
yolact_resnet50_pascal_config_incremental_15with5 = yolact_resnet50_config.copy({
    'name': None, # Will default to yolact_resnet50_pascal
...
yolact_resnet50_pascal_config_init_15with5 = yolact_resnet50_config.copy({
    'name': None,  # Will default to yolact_resnet50_pascal
...
yolact_resnet50_pascal_config_init_10with1 = yolact_resnet50_config.copy({
    'name': None,  # Will default to yolact_resnet50_pascal
...
yolact_resnet50_pascal_config_init_5with3 = yolact_resnet50_config.copy({
    'name': None,  # Will default to yolact_resnet50_pascal
...
yolact_mitb2_pascal_config_expert = yolact_resnet50_config.copy({
    'name': 'mix_transformer',  # Will default to yolact_resnet50_pascal
...
yolact_mitb2_pascal_config_init_15with5 = yolact_resnet50_config.copy({
    'name': 'mix_transformer',  # Will default to yolact_resnet50_pascal
...
yolact_mitb2_pascal_config_expert_15with5 = yolact_resnet50_config.copy({
    'name': 'mix_transformer',  # Will default to yolact_resnet50_pascal
...
yolact_mitb2_pascal_config_incremental_15with5 = yolact_resnet50_config.copy({
    'name': 'mix_transformer', # Will default to yolact_resnet50_pascal
...
SAT_yolact_mitb2_pascal_config_incremental_15with5 = yolact_resnet50_config.copy({
    # 'name': 'SAT_15-5_1', # Will default to yolact_resnet50_pascal
    'name': 'mix_transformer',
...
yolact_mitb2_pascal_config_init_15with1 = yolact_resnet50_config.copy({
    'name': 'mix_transformer',  # Will default to yolact_resnet50_pascal
...
yolact_mitb2_pascal_config_expert_15with1 = yolact_resnet50_config.copy({
    'name': 'mix_transformer',  # Will default to yolact_resnet50_pascal
...
yolact_mitb2_pascal_config_incremental_15with1 = yolact_resnet50_config.copy({
    'name': 'mix_transformer', # Will default to yolact_resnet50_pascal
...
yolact_mitb2_pascal_config_init_10with1 = yolact_resnet50_config.copy({
    'name': 'mix_transformer',  # Will default to yolact_resnet50_pascal
...
yolact_mitb2_pascal_config_expert_10with1 = yolact_resnet50_config.copy({
    'name': 'mix_transformer',  # Will default to yolact_resnet50_pascal
...
yolact_mitb2_pascal_config_expert_5with3 = yolact_resnet50_config.copy({
    'name': 'mix_transformer',  # Will default to yolact_resnet50_pascal
...
yolact_mitb2_pascal_config_incremental_10with1 = yolact_resnet50_config.copy({
    'name': 'mix_transformer', # Will default to yolact_resnet50_pascal
...
yolact_mitb2_pascal_config_init_5with3 = yolact_resnet50_config.copy({
    'name': 'mix_transformer',  # Will default to yolact_resnet50_pascal
...
yolact_mitb2_pascal_config_incremental_5with3 = yolact_resnet50_config.copy({
    'name': 'mix_transformer', # Will default to yolact_resnet50_pascal
...
SAT_yolact_mitb2_pascal_config_incremental_5with3_1 = yolact_resnet50_config.copy({
    'name': 'mix_transformer', # Will default to yolact_resnet50_pascal
    'loss_type': 'SAT_loss',
...
SAT_yolact_mitb2_pascal_config_incremental_10with10 = yolact_resnet50_config.copy({
    'name': 'mix_transformer', # Will default to yolact_resnet50_pascal
    'loss_type': 'SAT_loss',
...
MT_yolact_mitb2_pascal_config_incremental_10with5_1_expert = yolact_resnet50_config.copy({
    'name': 'mix_transformer', # Will default to yolact_resnet50_pascal
    # 'loss_type': 'SAT_loss',
...
MT_yolact_mitb2_pascal_config_incremental_10with5_1_incremental = yolact_resnet50_config.copy({
    'name': 'mix_transformer', # Will default to yolact_resnet50_pascal
    # 'loss_type': 'SAT_loss',
...
MT_yolact_mitb2_pascal_config_incremental_10with5_2_expert = yolact_resnet50_config.copy({
    'name': 'mix_transformer', # Will default to yolact_resnet50_pascal
    # 'loss_type': 'SAT_loss',
...
MT_yolact_mitb2_pascal_config_incremental_10with5_2_incremental = yolact_resnet50_config.copy({
    'name': 'mix_transformer', # Will default to yolact_resnet50_pascal
    # 'loss_type': 'SAT_loss',
...
SAT_yolact_mitb2_pascal_config_incremental_10with5_1 = yolact_resnet50_config.copy({
    'name': 'mix_transformer', # Will default to yolact_resnet50_pascal
    'loss_type': 'SAT_loss',
...
SAT_yolact_mitb2_pascal_config_incremental_10with5_2 = yolact_resnet50_config.copy({
    'name': 'mix_transformer', # Will default to yolact_resnet50_pascal
    'loss_type': 'SAT_loss',
